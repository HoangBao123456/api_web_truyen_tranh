<?php
$rendera = db_render("api/author/get_author");
...
if (isset($_POST['btn_serch'])) {
    ...
    redirect_to("?mod=author&act=search&name={$name}");
}
?>
            ...
            <div class="card_body">
                <form method="post" class="form_serch">
                    <div class="search search_input ">
                        <input type="text" class="form_control " name="name" placeholder="Tìm tác giả" value="">
                    </div>
                    <label class="search">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a href="?mod=author&act=update&id=<?php echo $item['id'] ?>">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                                                <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                                            </svg>
                                        </a>
                                        <form method="post" action="?mod=author&act=delete&id=<?php echo $item['id'] ?>">
